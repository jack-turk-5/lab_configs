...
socat -u FD:3 UDP:'[::]':51820,reuseaddr,fork &

# Container → host: listen internally, write back to FD 3
socat -u UDP-LISTEN:51820,reuseaddr,fork FD:3 &
...
socat -u FD:4 TCP:'[::]':51821,reuseaddr,fork &

# Container → host: listen internally, write back to FD 4
socat -u TCP-LISTEN:51821,reuseaddr,fork FD:4 &
